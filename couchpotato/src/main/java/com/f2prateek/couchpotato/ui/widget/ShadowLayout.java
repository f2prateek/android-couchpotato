...
public class ShadowLayout extends LinearLayout {
  ...
  private void init() {
    ...
    mShadowBitmap =
        Bitmap.createBitmap(sShadowRect.width(), sShadowRect.height(), Bitmap.Config.ARGB_8888);
    ...
    c.drawRoundRect(sShadowRectF, sShadowRectF.width() / 40, sShadowRectF.height() / 40,
        mShadowPaint);
  }

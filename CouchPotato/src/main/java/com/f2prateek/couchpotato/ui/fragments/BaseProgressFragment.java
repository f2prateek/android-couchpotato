...
public abstract class BaseProgressFragment extends BaseFragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    return inflater.inflate(R.layout.base_progress_fragment, container, false);
  }
  ...
  /**
   * The default content for a BaseProgressFragment has a TextView that can be shown when
